...
(function($) {
	...
	$.fn.pbvideosc = function(pbv_settings) {
		pbv_settings = jQuery.extend({
			...
			vimeo_oldmarkup: '<embed src="{path}" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="{width}" height="{height}"></embed>',
			...
			$pbv_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pbv_images[set_position])){
					...
					case 'vimeo':
						...
						movie = 'http://vimeo.com/moogaloop.swf?clip_id='+ match[2] +'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00ADEF&amp;fullscreen=1&amp;autoplay=1&amp;loop=0';
